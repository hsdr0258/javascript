...
import product1 from "./assets/images/quan.webp";
import {
  FaSearch,
  FaRegUser,
  FaFacebook,
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <p>Email: hsdr0258@example.com</p>
              <p>Điện thoại: 0779084817</p>
            </div>
          </div>
          {/* icon mạng xã hội */}
          <div class="row mt-3">
          ...
          <div class="row mt-3">
            <div class="col text-center">
              <p class="mb-0">
                Copyright © 2024 <a href="#">Sam Store</a>. All rights
                reserved.
              </p>
            </div>
          </div>
